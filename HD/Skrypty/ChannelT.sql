...
IF OBJECT_ID('[HD].[dbo].[ChannelT]', 'U') IS NOT NULL 
  DROP TABLE [HD].[dbo].[ChannelT]; 



CREATE TABLE [HD].[dbo].[ChannelT](
...
WHILE @@FETCH_STATUS = 0 
   BEGIN 
	  ...
	  INSERT INTO [HD].[dbo].[ChannelT] (Channel_ID, Nazwa, Kategoria, Grupa)
